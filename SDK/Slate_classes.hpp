...
static_assert(sizeof(UButtonWidgetStyle) == 0x0003D0, "Wrong size on UButtonWidgetStyle");
...
static_assert(sizeof(UCheckBoxWidgetStyle) == 0x000840, "Wrong size on UCheckBoxWidgetStyle");
...
static_assert(sizeof(UComboButtonWidgetStyle) == 0x0005B0, "Wrong size on UComboButtonWidgetStyle");
...
static_assert(sizeof(UEditableTextBoxWidgetStyle) == 0x000BE0, "Wrong size on UEditableTextBoxWidgetStyle");
...
static_assert(sizeof(UProgressWidgetStyle) == 0x0002B0, "Wrong size on UProgressWidgetStyle");
...
static_assert(sizeof(UScrollBarWidgetStyle) == 0x000790, "Wrong size on UScrollBarWidgetStyle");
...
static_assert(sizeof(USpinBoxWidgetStyle) == 0x000490, "Wrong size on USpinBoxWidgetStyle");
