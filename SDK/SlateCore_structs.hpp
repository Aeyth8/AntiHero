...
static_assert(sizeof(FTableRowStyle) == 0x000BC0, "Wrong size on FTableRowStyle");
...
static_assert(offsetof(FTableRowStyle, EvenRowBackgroundHoveredBrush) == 0x000420, "Member 'FTableRowStyle::EvenRowBackgroundHoveredBrush' has a wrong offset!");
static_assert(offsetof(FTableRowStyle, EvenRowBackgroundBrush) == 0x0004F0, "Member 'FTableRowStyle::EvenRowBackgroundBrush' has a wrong offset!");
static_assert(offsetof(FTableRowStyle, OddRowBackgroundHoveredBrush) == 0x0005C0, "Member 'FTableRowStyle::OddRowBackgroundHoveredBrush' has a wrong offset!");
static_assert(offsetof(FTableRowStyle, OddRowBackgroundBrush) == 0x000690, "Member 'FTableRowStyle::OddRowBackgroundBrush' has a wrong offset!");
static_assert(offsetof(FTableRowStyle, TextColor) == 0x000760, "Member 'FTableRowStyle::TextColor' has a wrong offset!");
static_assert(offsetof(FTableRowStyle, SelectedTextColor) == 0x000788, "Member 'FTableRowStyle::SelectedTextColor' has a wrong offset!");
static_assert(offsetof(FTableRowStyle, DropIndicator_Above) == 0x0007B0, "Member 'FTableRowStyle::DropIndicator_Above' has a wrong offset!");
static_assert(offsetof(FTableRowStyle, DropIndicator_Onto) == 0x000880, "Member 'FTableRowStyle::DropIndicator_Onto' has a wrong offset!");
static_assert(offsetof(FTableRowStyle, DropIndicator_Below) == 0x000950, "Member 'FTableRowStyle::DropIndicator_Below' has a wrong offset!");
static_assert(offsetof(FTableRowStyle, ActiveHighlightedBrush) == 0x000A20, "Member 'FTableRowStyle::ActiveHighlightedBrush' has a wrong offset!");
static_assert(offsetof(FTableRowStyle, InactiveHighlightedBrush) == 0x000AF0, "Member 'FTableRowStyle::InactiveHighlightedBrush' has a wrong offset!");
...
static_assert(offsetof(FTextBlockStyle, StrikeBrush) == 0x0001B0, "Member 'FTextBlockStyle::StrikeBrush' has a wrong offset!");
static_assert(offsetof(FTextBlockStyle, UnderlineBrush) == 0x000280, "Member 'FTextBlockStyle::UnderlineBrush' has a wrong offset!");
...
static_assert(sizeof(FSpinBoxStyle) == 0x000460, "Wrong size on FSpinBoxStyle");
static_assert(offsetof(FSpinBoxStyle, BackgroundBrush) == 0x000010, "Member 'FSpinBoxStyle::BackgroundBrush' has a wrong offset!");
static_assert(offsetof(FSpinBoxStyle, HoveredBackgroundBrush) == 0x0000E0, "Member 'FSpinBoxStyle::HoveredBackgroundBrush' has a wrong offset!");
static_assert(offsetof(FSpinBoxStyle, ActiveFillBrush) == 0x0001B0, "Member 'FSpinBoxStyle::ActiveFillBrush' has a wrong offset!");
static_assert(offsetof(FSpinBoxStyle, InactiveFillBrush) == 0x000280, "Member 'FSpinBoxStyle::InactiveFillBrush' has a wrong offset!");
static_assert(offsetof(FSpinBoxStyle, ArrowsImage) == 0x000350, "Member 'FSpinBoxStyle::ArrowsImage' has a wrong offset!");
static_assert(offsetof(FSpinBoxStyle, ForegroundColor) == 0x000420, "Member 'FSpinBoxStyle::ForegroundColor' has a wrong offset!");
static_assert(offsetof(FSpinBoxStyle, TextPadding) == 0x000448, "Member 'FSpinBoxStyle::TextPadding' has a wrong offset!");
...
static_assert(sizeof(FButtonStyle) == 0x0003A0, "Wrong size on FButtonStyle");
...
static_assert(offsetof(FButtonStyle, NormalPadding) == 0x000350, "Member 'FButtonStyle::NormalPadding' has a wrong offset!");
static_assert(offsetof(FButtonStyle, PressedPadding) == 0x000360, "Member 'FButtonStyle::PressedPadding' has a wrong offset!");
static_assert(offsetof(FButtonStyle, PressedSlateSound) == 0x000370, "Member 'FButtonStyle::PressedSlateSound' has a wrong offset!");
static_assert(offsetof(FButtonStyle, HoveredSlateSound) == 0x000388, "Member 'FButtonStyle::HoveredSlateSound' has a wrong offset!");
...
static_assert(sizeof(FScrollBarStyle) == 0x000760, "Wrong size on FScrollBarStyle");
...
static_assert(sizeof(FEditableTextBoxStyle) == 0x000BB0, "Wrong size on FEditableTextBoxStyle");
...
static_assert(offsetof(FEditableTextBoxStyle, ForegroundColor) == 0x0003B8, "Member 'FEditableTextBoxStyle::ForegroundColor' has a wrong offset!");
static_assert(offsetof(FEditableTextBoxStyle, BackgroundColor) == 0x0003E0, "Member 'FEditableTextBoxStyle::BackgroundColor' has a wrong offset!");
static_assert(offsetof(FEditableTextBoxStyle, ReadOnlyForegroundColor) == 0x000408, "Member 'FEditableTextBoxStyle::ReadOnlyForegroundColor' has a wrong offset!");
static_assert(offsetof(FEditableTextBoxStyle, HScrollBarPadding) == 0x000430, "Member 'FEditableTextBoxStyle::HScrollBarPadding' has a wrong offset!");
static_assert(offsetof(FEditableTextBoxStyle, VScrollBarPadding) == 0x000440, "Member 'FEditableTextBoxStyle::VScrollBarPadding' has a wrong offset!");
static_assert(offsetof(FEditableTextBoxStyle, ScrollBarStyle) == 0x000450, "Member 'FEditableTextBoxStyle::ScrollBarStyle' has a wrong offset!");
...
static_assert(sizeof(FInlineEditableTextBlockStyle) == 0x000F10, "Wrong size on FInlineEditableTextBlockStyle");
...
static_assert(offsetof(FInlineEditableTextBlockStyle, TextStyle) == 0x000BC0, "Member 'FInlineEditableTextBlockStyle::TextStyle' has a wrong offset!");
...
static_assert(sizeof(FComboButtonStyle) == 0x000580, "Wrong size on FComboButtonStyle");
static_assert(offsetof(FComboButtonStyle, ButtonStyle) == 0x000010, "Member 'FComboButtonStyle::ButtonStyle' has a wrong offset!");
static_assert(offsetof(FComboButtonStyle, DownArrowImage) == 0x0003B0, "Member 'FComboButtonStyle::DownArrowImage' has a wrong offset!");
...
static_assert(offsetof(FComboButtonStyle, MenuBorderPadding) == 0x000570, "Member 'FComboButtonStyle::MenuBorderPadding' has a wrong offset!");
...
static_assert(offsetof(FComboBoxStyle, PressedSlateSound) == 0x000590, "Member 'FComboBoxStyle::PressedSlateSound' has a wrong offset!");
static_assert(offsetof(FComboBoxStyle, SelectionChangeSlateSound) == 0x0005A8, "Member 'FComboBoxStyle::SelectionChangeSlateSound' has a wrong offset!");
...
static_assert(sizeof(FSearchBoxStyle) == 0x000F80, "Wrong size on FSearchBoxStyle");
static_assert(offsetof(FSearchBoxStyle, TextBoxStyle) == 0x000010, "Member 'FSearchBoxStyle::TextBoxStyle' has a wrong offset!");
static_assert(offsetof(FSearchBoxStyle, ActiveFontInfo) == 0x000BC0, "Member 'FSearchBoxStyle::ActiveFontInfo' has a wrong offset!");
static_assert(offsetof(FSearchBoxStyle, UpArrowImage) == 0x000C20, "Member 'FSearchBoxStyle::UpArrowImage' has a wrong offset!");
static_assert(offsetof(FSearchBoxStyle, DownArrowImage) == 0x000CF0, "Member 'FSearchBoxStyle::DownArrowImage' has a wrong offset!");
static_assert(offsetof(FSearchBoxStyle, GlassImage) == 0x000DC0, "Member 'FSearchBoxStyle::GlassImage' has a wrong offset!");
static_assert(offsetof(FSearchBoxStyle, ClearImage) == 0x000E90, "Member 'FSearchBoxStyle::ClearImage' has a wrong offset!");
static_assert(offsetof(FSearchBoxStyle, ImagePadding) == 0x000F60, "Member 'FSearchBoxStyle::ImagePadding' has a wrong offset!");
static_assert(offsetof(FSearchBoxStyle, bLeftAlignButtons) == 0x000F70, "Member 'FSearchBoxStyle::bLeftAlignButtons' has a wrong offset!");
...
static_assert(sizeof(FWindowStyle) == 0x0017F0, "Wrong size on FWindowStyle");
...
static_assert(offsetof(FWindowStyle, MaximizeButtonStyle) == 0x0003B0, "Member 'FWindowStyle::MaximizeButtonStyle' has a wrong offset!");
static_assert(offsetof(FWindowStyle, RestoreButtonStyle) == 0x000750, "Member 'FWindowStyle::RestoreButtonStyle' has a wrong offset!");
static_assert(offsetof(FWindowStyle, CloseButtonStyle) == 0x000AF0, "Member 'FWindowStyle::CloseButtonStyle' has a wrong offset!");
static_assert(offsetof(FWindowStyle, TitleTextStyle) == 0x000E90, "Member 'FWindowStyle::TitleTextStyle' has a wrong offset!");
static_assert(offsetof(FWindowStyle, ActiveTitleBrush) == 0x0011E0, "Member 'FWindowStyle::ActiveTitleBrush' has a wrong offset!");
static_assert(offsetof(FWindowStyle, InactiveTitleBrush) == 0x0012B0, "Member 'FWindowStyle::InactiveTitleBrush' has a wrong offset!");
static_assert(offsetof(FWindowStyle, FlashTitleBrush) == 0x001380, "Member 'FWindowStyle::FlashTitleBrush' has a wrong offset!");
static_assert(offsetof(FWindowStyle, BackgroundColor) == 0x001450, "Member 'FWindowStyle::BackgroundColor' has a wrong offset!");
static_assert(offsetof(FWindowStyle, OutlineBrush) == 0x001480, "Member 'FWindowStyle::OutlineBrush' has a wrong offset!");
static_assert(offsetof(FWindowStyle, OutlineColor) == 0x001550, "Member 'FWindowStyle::OutlineColor' has a wrong offset!");
static_assert(offsetof(FWindowStyle, BorderBrush) == 0x001580, "Member 'FWindowStyle::BorderBrush' has a wrong offset!");
static_assert(offsetof(FWindowStyle, BackgroundBrush) == 0x001650, "Member 'FWindowStyle::BackgroundBrush' has a wrong offset!");
static_assert(offsetof(FWindowStyle, ChildBackgroundBrush) == 0x001720, "Member 'FWindowStyle::ChildBackgroundBrush' has a wrong offset!");
...
static_assert(sizeof(FHeaderRowStyle) == 0x001180, "Wrong size on FHeaderRowStyle");
...
static_assert(offsetof(FHeaderRowStyle, BackgroundBrush) == 0x001080, "Member 'FHeaderRowStyle::BackgroundBrush' has a wrong offset!");
static_assert(offsetof(FHeaderRowStyle, ForegroundColor) == 0x001150, "Member 'FHeaderRowStyle::ForegroundColor' has a wrong offset!");
...
static_assert(sizeof(FDockTabStyle) == 0x000A70, "Wrong size on FDockTabStyle");
static_assert(offsetof(FDockTabStyle, CloseButtonStyle) == 0x000010, "Member 'FDockTabStyle::CloseButtonStyle' has a wrong offset!");
static_assert(offsetof(FDockTabStyle, NormalBrush) == 0x0003B0, "Member 'FDockTabStyle::NormalBrush' has a wrong offset!");
static_assert(offsetof(FDockTabStyle, ActiveBrush) == 0x000480, "Member 'FDockTabStyle::ActiveBrush' has a wrong offset!");
static_assert(offsetof(FDockTabStyle, ColorOverlayTabBrush) == 0x000550, "Member 'FDockTabStyle::ColorOverlayTabBrush' has a wrong offset!");
static_assert(offsetof(FDockTabStyle, ColorOverlayIconBrush) == 0x000620, "Member 'FDockTabStyle::ColorOverlayIconBrush' has a wrong offset!");
static_assert(offsetof(FDockTabStyle, ForegroundBrush) == 0x0006F0, "Member 'FDockTabStyle::ForegroundBrush' has a wrong offset!");
static_assert(offsetof(FDockTabStyle, HoveredBrush) == 0x0007C0, "Member 'FDockTabStyle::HoveredBrush' has a wrong offset!");
static_assert(offsetof(FDockTabStyle, ContentAreaBrush) == 0x000890, "Member 'FDockTabStyle::ContentAreaBrush' has a wrong offset!");
static_assert(offsetof(FDockTabStyle, TabWellBrush) == 0x000960, "Member 'FDockTabStyle::TabWellBrush' has a wrong offset!");
static_assert(offsetof(FDockTabStyle, TabPadding) == 0x000A30, "Member 'FDockTabStyle::TabPadding' has a wrong offset!");
static_assert(offsetof(FDockTabStyle, OverlapWidth) == 0x000A40, "Member 'FDockTabStyle::OverlapWidth' has a wrong offset!");
static_assert(offsetof(FDockTabStyle, FlashColor) == 0x000A48, "Member 'FDockTabStyle::FlashColor' has a wrong offset!");
...
static_assert(sizeof(FProgressBarStyle) == 0x000280, "Wrong size on FProgressBarStyle");
...
static_assert(sizeof(FHyperlinkStyle) == 0x000710, "Wrong size on FHyperlinkStyle");
static_assert(offsetof(FHyperlinkStyle, UnderlineStyle) == 0x000010, "Member 'FHyperlinkStyle::UnderlineStyle' has a wrong offset!");
static_assert(offsetof(FHyperlinkStyle, TextStyle) == 0x0003B0, "Member 'FHyperlinkStyle::TextStyle' has a wrong offset!");
static_assert(offsetof(FHyperlinkStyle, Padding) == 0x000700, "Member 'FHyperlinkStyle::Padding' has a wrong offset!");
...
static_assert(sizeof(FCheckBoxStyle) == 0x000810, "Wrong size on FCheckBoxStyle");
...
static_assert(offsetof(FCheckBoxStyle, ForegroundColor) == 0x000770, "Member 'FCheckBoxStyle::ForegroundColor' has a wrong offset!");
static_assert(offsetof(FCheckBoxStyle, BorderBackgroundColor) == 0x000798, "Member 'FCheckBoxStyle::BorderBackgroundColor' has a wrong offset!");
static_assert(offsetof(FCheckBoxStyle, CheckedSlateSound) == 0x0007C0, "Member 'FCheckBoxStyle::CheckedSlateSound' has a wrong offset!");
static_assert(offsetof(FCheckBoxStyle, UncheckedSlateSound) == 0x0007D8, "Member 'FCheckBoxStyle::UncheckedSlateSound' has a wrong offset!");
static_assert(offsetof(FCheckBoxStyle, HoveredSlateSound) == 0x0007F0, "Member 'FCheckBoxStyle::HoveredSlateSound' has a wrong offset!");
