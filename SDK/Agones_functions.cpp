...
void UAgonesComponent::SetAnnotation(class FString* Key, class FString* Value, TDelegate<void(struct FEmptyResponse& Response)> SuccessDelegate, TDelegate<void(struct FAgonesError& Error)> ErrorDelegate)
{
	static class UFunction* Func = nullptr;
...
void UAgonesComponent::SetLabel(class FString* Key, class FString* Value, TDelegate<void(struct FEmptyResponse& Response)> SuccessDelegate, TDelegate<void(struct FAgonesError& Error)> ErrorDelegate)
{
	static class UFunction* Func = nullptr;
