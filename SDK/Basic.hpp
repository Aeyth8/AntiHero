...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0603D010;
	constexpr int32 AppendString      = 0x015A8250;
	constexpr int32 GNames            = 0x06000CC0;
	constexpr int32 GWorld            = 0x06189A70;
	constexpr int32 ProcessEvent      = 0x01797070;
