...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"BP_ActionJumpBeginForward_C">();
	}
...
static_assert(alignof(UBP_ActionJumpBeginForward_C) == 0x000008, "Wrong alignment on UBP_ActionJumpBeginForward_C");
static_assert(sizeof(UBP_ActionJumpBeginForward_C) == 0x0001C0, "Wrong size on UBP_ActionJumpBeginForward_C");
static_assert(offsetof(UBP_ActionJumpBeginForward_C, UberGraphFrame) == 0x0001B0, "Member 'UBP_ActionJumpBeginForward_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UBP_ActionJumpBeginForward_C, HoldTime) == 0x0001B8, "Member 'UBP_ActionJumpBeginForward_C::HoldTime' has a wrong offset!");
