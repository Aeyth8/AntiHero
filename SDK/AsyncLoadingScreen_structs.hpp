...
static_assert(sizeof(FLoadingWidgetSettings) == 0x0002D0, "Wrong size on FLoadingWidgetSettings");
...
static_assert(offsetof(FLoadingWidgetSettings, CircularThrobberSettings) == 0x0001C0, "Member 'FLoadingWidgetSettings::CircularThrobberSettings' has a wrong offset!");
static_assert(offsetof(FLoadingWidgetSettings, ImageSequenceSettings) == 0x0002A0, "Member 'FLoadingWidgetSettings::ImageSequenceSettings' has a wrong offset!");
static_assert(offsetof(FLoadingWidgetSettings, TextAlignment) == 0x0002C0, "Member 'FLoadingWidgetSettings::TextAlignment' has a wrong offset!");
static_assert(offsetof(FLoadingWidgetSettings, LoadingIconAlignment) == 0x0002C2, "Member 'FLoadingWidgetSettings::LoadingIconAlignment' has a wrong offset!");
static_assert(offsetof(FLoadingWidgetSettings, Space) == 0x0002C4, "Member 'FLoadingWidgetSettings::Space' has a wrong offset!");
...
static_assert(sizeof(FALoadingScreenSettings) == 0x0004D0, "Wrong size on FALoadingScreenSettings");
...
static_assert(offsetof(FALoadingScreenSettings, Layout) == 0x0004C0, "Member 'FALoadingScreenSettings::Layout' has a wrong offset!");
